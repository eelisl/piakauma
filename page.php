...
if (has_post_thumbnail()) :
	$featured_image = wp_get_attachment_url(get_post_thumbnail_id($post->ID)); ?>
		<div class="entry-header-page" style="background-image: url(<?php echo $featured_image; ?>); background-position: 50% <?php if($image_position): echo $image_position; else: echo "50"?>%"></div>
<?php endif; ?>
